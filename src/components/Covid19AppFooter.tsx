...
const Covid19AppFooter = (): JSX.Element => {
    return <footer className="covid19-app-footer p-grid p-nogutter">
        <div className="p-col-8">Powered by <a href="https://reactjs.org/" target="_blank">React</a> and <a href="https://www.primefaces.org/primereact/" target="_blank">PrimeReact</a></div>
